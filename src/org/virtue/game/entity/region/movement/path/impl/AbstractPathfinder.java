package org.virtue.game.entity.region.movement.path.impl;
...
import org.virtue.game.entity.region.movement.path.Pathfinder;
...
public abstract class AbstractPathfinder implements Pathfinder {
	...
	public static Tile findAdjacent(Entity entity) {
		if (AbstractPathfinder.find(entity, entity.getCurrentTile().copyNew(-1, 0, 0), false, AbstractPathfinder.DUMB).isSuccessful()) {
			return entity.getCurrentTile().copyNew(-1, 0, 0);
		}
		if (AbstractPathfinder.find(entity, entity.getCurrentTile().copyNew(0, -1, 0), false, AbstractPathfinder.DUMB).isSuccessful()) {
