...
public final class SmartPathfinder extends AbstractPathfinder {
	...
	public Path find(Tile start, int moverSize, Tile end, int sizeX, int sizeY, int rotation, int type, int walkingFlag, boolean near) {
		...
		Tile location = new Tile((start.getChunkX() - 6) << 3, (start.getChunkY() - 6) << 3, z);
	 ...
	 */
	private void checkSingleTraversal(Tile end, int sizeX, int sizeY, int type, int rotation, int walkingFlag, Tile location) {
		int readPosition = 0;
