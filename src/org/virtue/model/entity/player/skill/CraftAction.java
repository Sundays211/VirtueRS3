...
public class CraftAction implements PlayerActionHandler {
	...
	/* (non-Javadoc)
	 * @see org.virtue.model.entity.player.event.PlayerActionHandler#process(org.virtue.model.entity.player.Player)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.virtue.model.entity.player.event.PlayerActionHandler#stop(org.virtue.model.entity.player.Player)
	 */
	@Override
