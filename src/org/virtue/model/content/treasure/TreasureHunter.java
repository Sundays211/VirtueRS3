...
public final class TreasureHunter {
	...
	/**
	 * The amount of Hearts of Ice the player has.
	 */
	...
	public void open() {
		...
		player.getDispatcher().sendVarc(4082, heartAmount);
...
//		player.getVars().setVarValueInt(3842, -1);
	...
	/**
	 * Gets the heartAmount value.
	 * @return The heartAmount.
	 */
	...
	/**
	 * Sets the heartAmount value.
	 * @param heartAmount The heartAmount to set.
	 */
