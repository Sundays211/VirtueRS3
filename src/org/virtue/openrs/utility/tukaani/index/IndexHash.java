...
import org.virtue.openrs.utility.tukaani.CorruptedInputException;
import org.virtue.openrs.utility.tukaani.XZIOException;
import org.virtue.openrs.utility.tukaani.common.DecoderUtil;

public class IndexHash extends IndexBase {
    private org.virtue.openrs.utility.tukaani.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new org.virtue.openrs.utility.tukaani.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new org.virtue.openrs.utility.tukaani.check.CRC32();
        }
    }
