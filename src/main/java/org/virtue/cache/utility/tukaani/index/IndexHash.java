...
import org.virtue.cache.utility.tukaani.XZIOException;
import org.virtue.cache.utility.tukaani.common.DecoderUtil;

public class IndexHash extends IndexBase {
    private org.virtue.cache.utility.tukaani.check.Check hash;

    public IndexHash() {
        super(new CorruptedInputException());

        try {
            hash = new org.virtue.cache.utility.tukaani.check.SHA256();
        } catch (java.security.NoSuchAlgorithmException e) {
            hash = new org.virtue.cache.utility.tukaani.check.CRC32();
        }
    }
