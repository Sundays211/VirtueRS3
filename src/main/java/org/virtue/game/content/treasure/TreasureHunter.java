...
public final class TreasureHunter {
	...
	public void sendReward(Prize prize, int chestIndex, boolean instant, boolean openAll, int heartsUsed) {
		...
		player.getVars().setVarBitValue(20738, 1);
		player.getVars().setVarBitValue(20749, 0);
		player.getVars().setVarBitValue(20739, 1);
		player.getVars().setVarBitValue(20752, 1);
		player.getVars().setVarBitValue(20751, 0);
		player.getVars().setVarBitValue(25533, 1);
		player.getVars().setVarBitValue(28369, 1);
		player.getVars().setVarBitValue(28370, 0);
		player.getVars().setVarBitValue(20744, 12);
		player.getVars().setVarBitValue(20738, 0);
		player.getVars().setVarBitValue(20749, 90);
		player.getVars().setVarBitValue(20739, 0);
		player.getVars().setVarBitValue(20750, 73);
		player.getVars().setVarBitValue(20752, 0);
		player.getVars().setVarBitValue(20751, 30);
		player.getVars().setVarBitValue(25533, 0);
		player.getVars().setVarBitValue(25534, 30);
		player.getVars().setVarBitValue(28369, 0);
		player.getVars().setVarBitValue(28370, 15);
		player.getVars().setVarBitValue(20736, 1289);
		player.getVars().setVarBitValue(20747, 1);
		player.getVars().setVarBitValue(20742, 1);
		player.getVars().setVarBitValue(20738, 1);
		player.getVars().setVarBitValue(20749, 0);
		player.getVars().setVarBitValue(20739, 1);
		player.getVars().setVarBitValue(20752, 1);
		...
		player.getVars().setVarBitValue(28369, 1);
		player.getVars().setVarBitValue(28370, 0);
		player.getVars().setVarBitValue(20744, 11);
		player.getVars().setVarBitValue(20738, 0);
		player.getVars().setVarBitValue(20749, 89);
		player.getVars().setVarBitValue(20739, 0);
		player.getVars().setVarBitValue(20750, 72);
		player.getVars().setVarBitValue(20752, 0);
		player.getVars().setVarBitValue(20751, 29);
		player.getVars().setVarBitValue(25533, 0);
		player.getVars().setVarBitValue(25534, 29);
		player.getVars().setVarBitValue(28369, 0);
		player.getVars().setVarBitValue(28370, 14);
		player.getVars().setVarBitValue(20736, 1288);
		player.getVars().setVarBitValue(20747, 2);
		player.getVars().setVarBitValue(20742, 2);
		player.getVars().setVarBitValue(20738, 1);
		player.getVars().setVarBitValue(20749, 0);
		player.getVars().setVarBitValue(20739, 1);
		player.getVars().setVarBitValue(20752, 1);
		...
		player.getVars().setVarBitValue(28369, 1);
		player.getVars().setVarBitValue(28370, 0);
		player.getVars().setVarBitValue(20744, 10);
		player.getVars().setVarBitValue(20738, 0);
		player.getVars().setVarBitValue(20749, 88);
		player.getVars().setVarBitValue(20739, 0);
		player.getVars().setVarBitValue(20750, 71);
		player.getVars().setVarBitValue(20752, 0);
		player.getVars().setVarBitValue(20751, 28);
		player.getVars().setVarBitValue(25533, 0);
		player.getVars().setVarBitValue(25534, 28);
		player.getVars().setVarBitValue(28369, 0);
		player.getVars().setVarBitValue(28370, 13);
