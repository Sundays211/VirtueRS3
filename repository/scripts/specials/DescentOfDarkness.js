...
var darkBow = new SpecialAttack(CombatStyle.RANGE, [11235]) {
	getImpacts : function(entity, lock) {
		return [Java.super(darkBow).impact(entity, lock, CombatStyle.RANGE, new GraphicsBlock(1, 1100), new Projectile(1099, 48, 72, 16, 34, 16)),
		        Java.super(darkBow).impact(entity, lock, CombatStyle.RANGE, new GraphicsBlock(1, 1100), new Projectile(1099, 60, 90, 16, 34, 16))];
	},
};
